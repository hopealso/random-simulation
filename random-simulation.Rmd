...
One random event that is available all of those who live in a metropolitan area is the movement of cars on the roads that surround us. To generate our random sequence we combined the allure of statistics with the draw to spend time with our family, and spent two hours recording the movement of cars along a relatively busy throughfare in the North Center neighborhood of Chicago.
