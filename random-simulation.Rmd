...
* _Style Guide:_ https://google.github.io/styleguide/Rguide.xml#functiondefinition
...
As seen in the histogram, when we group our 1000 numbers into bins of width one tenth (0.1), each of these bins holds approximately 100 numbers, with some variation. This is as expected (i.e. 1000/10 = 100 and 1/10 = 0.1). Our sample of continuous numbers appears to be evenly distributed between the bounds of 0 and 1, as expected for a distribution of X ~ Unif(0,1) and appears consistent with the goal of our simulation.
...
The first moment (mean) and the second central moment (variance) tell us, respectively, the center of our sample and the spread of our sample. These are also as expected. 

For a uniform distribution we expect that the center of our data will be midway through the range of the distribution. Thus the sample mean of 0.516 is quite close to our expected theoretical mean of 0.5 (midway between 0 and 1, or (1-0)/2). We expect that the variance of our data will be $\frac{(b-a)^{2}}{12}$, or 1/12, and our sample mean of 0.084 is quite close to this.
