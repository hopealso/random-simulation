...
```{r q2-1-1-hist}
hist.sample.runif <- hist(sample.runif, 
                          main = "100 Pseudo-Random Numbers, Transformed from Random.org Binary Data")
hist.sample.runif
boxplot(sample.runif, 
        main = "100 Pseudo-Random Numbers, Transformed from Random.org Binary Data")
```
...
```{r q2-1-2-hist}
hist.random.org <- hist(sample.random.org, main = "1000 Pseudo-Random Numbers via Runif()")
hist.random.org
boxplot(sample.random.org, main = "1000 Pseudo-Random Numbers via Runif()")
```
